...
let TypeOrmModule = TypeOrmModule_1 = class TypeOrmModule {
    ...
    static forFeature(entities = [], connection = typeorm_constants_1.DEFAULT_CONNECTION_NAME) {
        const providers = (0, typeorm_providers_1.createTypeOrmProviders)(entities, connection);
        const customRepositoryEntities = (0, get_custom_repository_entity_1.getCustomRepositoryEntity)(entities);
