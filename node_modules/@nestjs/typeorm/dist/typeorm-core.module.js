...
let TypeOrmCoreModule = TypeOrmCoreModule_1 = class TypeOrmCoreModule {
    ...
    static forRoot(options = {}) {
        ...
        const connectionProvider = {
            provide: (0, typeorm_utils_1.getConnectionToken)(options),
    ...
    static forRootAsync(options) {
        ...
        const entityManagerProvider = {
            ...
            inject: [(0, typeorm_utils_1.getConnectionToken)(options)],
        };
    ...
    onApplicationShutdown() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const connection = this.moduleRef.get((0, typeorm_utils_1.getConnectionToken)(this.options));
            try {
    ...
    static createConnectionFactory(options, connectionFactory) {
        return __awaiter(this, void 0, void 0, function* () {
            const connectionToken = (0, typeorm_utils_1.getConnectionName)(options);
            ...
            return yield (0, rxjs_1.lastValueFrom)((0, rxjs_1.defer)(() => {
                try {
                    if (options.keepConnectionAlive) {
                        const connectionName = (0, typeorm_utils_1.getConnectionName)(options);
                        const manager = (0, typeorm_1.getConnectionManager)();
                        if (manager.has(connectionName)) {
                            const connection = manager.get(connectionName);
                            if (connection.isConnected) {
                                return (0, rxjs_1.of)(connection);
                            }
                        }
                    }
                }
            ...
            }).pipe((0, typeorm_utils_1.handleRetry)(options.retryAttempts, options.retryDelay, connectionToken, options.verboseRetryLog, options.toRetry)));
        });
    }
};
