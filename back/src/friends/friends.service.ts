...
{
    constructor(@InjectRepository(FriendLsit) private friendListRepo: Repository<FriendLsit>,
    ...
    public async findAll(userId: Object) : Promise<FriendLsit[] | undefined>
    {
		...
		{
			const image: any = await this.userRepo.query(`select picture from public."Users" WHERE public."Users"."userName" = '${element.userName}'`);
