...
const ChatZone = (props: any) => {
  ...
  // useEffect(() => {
  //     axios.post(`http://${process.env.NEXT_PUBLIC_IP_ADRESSE}:${process.env.NEXT_PUBLIC_PORT}/message/getConnversation`,{userName: router.query.id},
  ...
  //         axios.post(`http://${process.env.NEXT_PUBLIC_IP_ADRESSE}:${process.env.NEXT_PUBLIC_PORT}/users/profile`,{userName: router.query.id},
  //         {headers:{'Authorization': `Bearer ${localStorage.getItem("accessToken")}`}}
  //         ).then((res) => {
  ...
  // },[messages,isTyping])
  // useEffect(() => {
  //     axios.get(`http://${process.env.NEXT_PUBLIC_IP_ADRESSE}:${process.env.NEXT_PUBLIC_PORT}/message/getConntacts`,
  //     {headers:{'Authorization': `Bearer ${localStorage.getItem("accessToken")}`}}
  //     ).then((res) => {
  //         setFriends(res.data);
  //     })
